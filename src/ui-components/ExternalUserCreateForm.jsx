...
export default function ExternalUserCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setCompanyLogoUrl(initialValues.companyLogoUrl);
    setDiscipline(initialValues.discipline);
    setRegistration_date(initialValues.registration_date);
    setRegistration_branch(initialValues.registration_branch);
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createExternalUser.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "ExternalUserCreateForm")}
      {...rest}
    >
      <TextField
        label="Name"
