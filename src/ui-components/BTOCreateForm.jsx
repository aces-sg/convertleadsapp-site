...
import { createBTO } from "../graphql/mutations";
const client = generateClient();
export default function BTOCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setEstate(initialValues.estate);
    setType(initialValues.type);
    setFloorPlanUrl(initialValues.floorPlanUrl);
    setBrochureUrl(initialValues.brochureUrl);
    setModel3DUrl(initialValues.model3DUrl);
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createBTO.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "BTOCreateForm")}
      {...rest}
    >
      <TextField
        label="Name"
