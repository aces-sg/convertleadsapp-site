...
const RevitServices = () => {
  ...
  const imagedata = useStaticQuery(graphql`
    {
      collab: file(relativePath: { eq: "bim-collaborate-pro.png" }) {
        childImageSharp {
          gatsbyImageData
        }
      }
  ...
  let sections = [
    {
      ...
      content: `Our specialists collaborate with your project team in Autodesk BIM Collaborate Pro. Synchronize changes between multiple disciplines to deliver clash-free, up-to-date BIM models & CAD files.`,
      linkText: "What is BIM Collaborate Pro?",
      linkHref: "/blog/bim-collaborate-vs-pro",
    ...
    },
    {
      ...
      content: `We resolve model issues in ACC as the project progresses through weekly virtual design reviews, ensuring the project stays on track.`,
    ...
    },
    {
      ...
      content: `We create detailed drawing sheets directly from BIM, ensuring the accuracy of construction BIM models.`,
  ...
  const handleDefault = () => {
    dispatch({
      ...
      payload: {
        show: true,
        message: "Request for Revit Services",
      },
    });
  };
  ...
  return (
    <div id="gtm-top">
      ...
      <main>
            ...
            <div className="relative z-0">
              ...
              <div className="text-center max-w-[810px] mx-auto">
                ...
                <p className="mb-0 text-sm text-gray-500 md:text-base lg:text-xl">
                  Work with our BIM Coordinators to develop Revit
                  models and Autocad files for submissions to Autodesk
        ...
        <TwoColumn
          title="ACC Workflows"
          description="Quality BIM & CAD submissions with ACC"
          sections={sections}
        />
