  ...
  let projectData = [
    {
      ...
      description:
        "Transform tender or as-built CAD drawings into accurate, information-rich BIM models.",
    },
    {
      src: imagedata.bim,
      alt: "BIM to Shop Drawings",
      title: "BIM to Shop Drawings",
      description:
        "Develop LOD 400 BIM models from tender drawings to generate precise shop drawings for construction.",
    },
    {
      src: imagedata.fourd,
      ...
      description:
        "Integrate project schedules (CSV, Microsoft Project, P6) with BIM models to create detailed 4D simulations.",
    },
    {
      src: imagedata.scan,
      alt: "Scan to BIM",
      title: "Scan to BIM",
      description:
        "Convert LIDAR-captured point clouds into accurate as-built BIM models through manual tracing and refinement.",
    },
  ];
      ...
      <div className="tw-container">
        <div className="flex justify-between items-start md:items-center md:flex-row flex-col gap-2.5 md:gap-0">
          ...
          <p className="text-left md:text-right max-w-[518px] text-gray-700 text-sm md:text-base mb-0">
            Our BIM team has worked on a number of Revit projects over
            the years
          </p>
        </div>
