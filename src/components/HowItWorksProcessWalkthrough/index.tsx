          ...
          <div className="md:w-[70%]">
            <div className="relative">
              <ProcessStep
                number="1"
                title="Share Files"
                description="Share any CAD plans, BIM models, or survey data with us. We will review them and provide feedback."
                Icon={ShareIcon}
              />
              ...
              <ProcessStep
                ...
                description="Our 3D experts create detailed 3D models and walkthroughs based on your specifications."
                Icon={ModelIcon}
              />
              ...
              <ProcessStep
                ...
                description="Review the completed work and start using the animated walkthroughs in your presentations."
                Icon={ReviewIcon}
              />
            </div>
          </div>
