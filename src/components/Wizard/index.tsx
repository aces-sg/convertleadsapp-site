...
const StepOne = () => {
  ...
  return (
    ...
    >
      <Box
        width={
          !["xsmall", "small"].includes(size) ? "medium" : "100%"
        }
        margin={{ bottom: "medium" }}
        gap="medium"
        flex={false}
...
const StepThree = () => (
  <Box gap="small">
    ...
    <Text color="text-strong">
      Include guidance to what will occur when “Finish wizard" is
      clicked.
    </Text>
  </Box>
);
...
const steps = [
  ...
  {
    description:
      "Provide a summary of what was accomplished or configured. ",
    inputs: <StepThree />,
    title: "Finish title",
  },
];

const Wizard = ({ containerRef }) => {
