...
export default function JobBenefits() {
  const benefits = [
    ...
    {
      name: "Major Project Exposure",
      description:
        "Work on prestigious rail, airport, and infrastructure projects",
      icon: (
        <svg
          className="w-6 h-6"
          fill="none"
      ...
      <div className="tw-container">
        <div className="max-w-3xl mx-auto text-center mb-12">
          ...
          <p className="text-lg text-gray-600">
            Join a team that values your growth and well-being. We offer
            competitive benefits and the opportunity to work on Singapore's most
